...
/* categorized-topic-active */
$('.categorized-topic-active').owlCarousel({
    stagePadding: 70,
    margin:15,
    loop:true,
    nav:true,
...
// 		center: new google.maps.LatLng(6.4288, 7.4981), // New York
...
// 		position: new google.maps.LatLng(6.4288, 7.4981),
// 		map: map,
// 		title: 'Cryptox'
// 	});
// }
